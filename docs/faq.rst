...
Example code can be found in the `examples folder <https://github.com/Rapptz/texus/tree/master/examples>`_
in the repository.
...
`Check the background_task.py example. <https://github.com/Rapptz/texus/blob/master/examples/background_task.py>`_
