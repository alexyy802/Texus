...
Example code can be found in the `examples folder <https://github.com/TexusDev/pycord/tree/master/examples>`_
in the repository.
...
`Check the background_task.py example. <https://github.com/TexusDev/pycord/blob/master/examples/background_task.py>`_
